...
type requestStreamHeader interface {
	ContentLength() int
	ReadTrailer(r *bufio.Reader) error
}

type requestStream struct {
	header          requestStreamHeader
...
func acquireRequestStream(b *bytebufferpool.ByteBuffer, r *bufio.Reader, h requestStreamHeader) *requestStream {
